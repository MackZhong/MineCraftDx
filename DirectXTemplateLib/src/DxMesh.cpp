...
void DxMesh::Draw( ID3D11DeviceContext* pDeviceContext )
{
...
std::unique_ptr<DxMesh> DxMesh::CreateSphere( ID3D11DeviceContext* pDeviceContext, float diameter, size_t tessellation, bool rhcoords )
{
    ...
    std::unique_ptr<DxMesh> mesh(new DxMesh());
...
std::unique_ptr<DxMesh> DxMesh::CreateCube( ID3D11DeviceContext* deviceContext, float size, bool rhcoords )
{
...
std::unique_ptr<DxMesh> DxMesh::CreateCone( ID3D11DeviceContext* deviceContext, float diameter, float height, size_t tessellation, bool rhcoords )
{
    VertexCollection vertices;
    IndexCollection indices;
...
std::unique_ptr<DxMesh> DxMesh::CreateTorus(_In_ ID3D11DeviceContext* deviceContext, float diameter, float thickness, size_t tessellation, bool rhcoords)
{
    VertexCollection vertices;
    IndexCollection indices;
...
void DxMesh::Initialize( ID3D11DeviceContext* deviceContext, VertexCollection& vertices, IndexCollection& indices, bool rhcoords )
{

...
DXGI_RATIONAL QueryRefreshRate( const DxWindow& window )
{
...
bool DxGame::ResizeSwapChain( int width, int height )
{
...
void DxGame::Clear( const FLOAT clearColor[4], FLOAT clearDepth, UINT8 clearStencil )
{
...
void DxGame::OnUpdate( UpdateEventArgs& e )
{

}

void DxGame::OnRender( RenderEventArgs& e )
{

}

void DxGame::OnKeyPressed( DxKeyEventArgs& e )
{
    // By default, do nothing.
}

void DxGame::OnKeyReleased( DxKeyEventArgs& e )
{
    // By default, do nothing.
}

void DxGame::OnMouseMoved(class MouseMotionEventArgs& e)
{
    // By default, do nothing.
}

void DxGame::OnMouseButtonPressed( MouseButtonEventArgs& e )
{
    // By default, do nothing.
}

void DxGame::OnMouseButtonReleased( MouseButtonEventArgs& e )
{
    // By default, do nothing.
}

void DxGame::OnMouseWheel( MouseWheelEventArgs& e )
{
    // By default, do nothing.
}

void DxGame::OnResize( ResizeEventArgs& e )
{
    assert( m_d3dSwapChain );
    ResizeSwapChain( e.Width, e.Height );
}

void DxGame::OnWindowDestroy()
{
